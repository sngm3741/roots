...
export function Services() {
  ...
  return (
    <section id="services" className="py-2 lg:py-4 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-gray-900 mb-4">
            <span className="block text-lg text-emerald-600 font-bold mb-2">SERVICES & PRICING</span>
        ...
        <div className="mt-12 text-center bg-emerald-50 p-8 rounded-lg">
          <p className="text-gray-700 mb-4">
            <span className="font-bold text-lg">まずはお気軽にご相談ください</span><br />
            写真があれば概算見積も可能です
          </p>
          <button
