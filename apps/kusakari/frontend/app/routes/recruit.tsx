import { Coffee, Heart, TrendingUp, Users } from "lucide-react";
  ...
  const positions = [
    {
      ...
      requirements: ["普通自動車免許（AT限定可）", "体力に自信のある方", "屋外作業が好きな方", "未経験者歓迎"],
      conditions: {
    ...
    },
    {
      ...
      requirements: ["普通自動車免許（AT限定可）", "週2日以上勤務できる方", "未経験者歓迎", "60歳以上の方も歓迎"],
      conditions: {
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-50 to-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">地域に貢献できる仕事</h2>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="flex items-center gap-6 bg-gray-50 p-6 rounded-lg">
