...
- [ ] (2025-12-31 00:00) 既存コード・ログ経路の調査完了
- [ ] (2025-12-31 00:00) ログ保存仕様（対象API/保存項目/保持期間）の確定
- [ ] (2025-12-31 00:00) D1テーブル追加（migration）
- [ ] (2025-12-31 00:00) 投稿系APIのログ書き込み実装
- [ ] (2025-12-31 00:00) 1年超ログの削除手段を実装（cron or 手動）
...
4. 1年超ログの削除方法を手動コマンドで実装し、運用手順を整理。
