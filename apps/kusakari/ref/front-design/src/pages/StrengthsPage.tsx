...
import { Award, MapPinned, Users, Clock, Shield, ThumbsUp } from 'lucide-react';
...
export function StrengthsPage() {
  const strengths = [
    ...
    },
    {
      ...
      title: '迅速対応',
      description: 'お問い合わせから最短3営業日で対応可能。緊急の草刈りニーズにも柔軟に対応します。',
      details: [
        'お見積もり当日～翌営業日に提出',
        '緊急対応も可能（別途相談）',
        '作業後の報告も迅速に実施'
    ...
    },
    {
      ...
      title: '万全の保険体制',
      description: '万が一の事故に備え、損害賠償保険に加入しています。安心してお任せください。',
      details: [
        '施設賠償責任保険加入済み',
        '作業中の事故にも対応',
        '安全第一の作業体制'
