      ...
      items: [
        {
          ...
          answer: '知多半島全域（半田市、常滑市、東海市、大府市、知多市、東浦町、阿久比町、武豊町、美浜町、南知多町）が対応エリアです。エリア外でも規模や条件によっては対応可能な場合がございますので、まずはお問い合わせください。'
        },
        {
          question: '見積もりは無料ですか？',
          answer: 'はい、お見積もりは無料です。現地の写真をお送りいただければ、概算見積もりも可能です。より正確なお見積もりをご希望の場合は、現地調査（無料）も承っております。'
        },
        {
      ...
      items: [
        {
          ...
          answer: '基本的には作業面積（㎡）で算出いたします。ただし、傾斜地や障害物が多い場合、機械が入れない場所などは追加料金が発生する場合がございます。お見積もり時に詳細をご説明いたします。'
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '小雨程度であれば作業可能ですが、安全を最優先するため、強い雨や悪天候の場合は延期させていただく場合がございます。'
        },
        {
          question: '立ち会いは必要ですか？',
          answer: '基本的には立ち会い不要です。ただし、初回や現地調査時はできる限りご在宅をお願いしております。作業後は写真付きの報告書をお送りいたします。'
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'はい、年間契約での定期管理も承っております。年3回〜のご訪問など、お客様のご要望に応じてスケジュールを組ませていただきます。'
        }
      ]
    }
  ];
